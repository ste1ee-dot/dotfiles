...
setup_fedora() {
    ...
    sudo dnf install tmux git make gawk unzip gzip fzf gcc nodejs npm ripgrep  golang sqlite3 wget tar dnf-plugins-core flatpak kitty -y
...
setup_ubuntu() {
    ...
    sudo apt-get install tmux git make gawk unzip gzip fzf gcc nodejs npm ripgrep golang-go sqlite3 wget tar flatpak kitty -y
